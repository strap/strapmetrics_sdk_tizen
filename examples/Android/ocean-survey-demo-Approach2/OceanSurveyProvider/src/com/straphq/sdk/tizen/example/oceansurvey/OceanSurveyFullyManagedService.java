...
public class OceanSurveyFullyManagedService extends SAAgent {
	...
	public final static int CHANNEL_ID = 104;
	...
	public class OceanSurveyFullyManagedServiceConnection extends SASocket {
		...
		public OceanSurveyFullyManagedServiceConnection() {
			...
			Log.d("OceanSurveyFullyManagedService",
					"OCEANSURVEY CONNECTION CONSTRUCTOR");
		}
		...
		public void onError(int channelId, String errorString, int error) {
			Log.e(TAG, "Connection is not alive ERROR: " + errorString + "  "
					+ error);
			Log.d("OceanSurveyFullyManagedService",
					"OCEANSURVEY CONNECTION ERROR " + errorString + " || "
							+ error);
		}
		...
		public void onReceive(int channelId, byte[] data) {
			...
			if (StrapMetrics.canHandleMessage(data)) {
				...
				String timeStr = " " + String.valueOf(time.hour) + ":"
				...
				final OceanSurveyFullyManagedServiceConnection uHandler = connectionMap
						.get(Integer.parseInt(String.valueOf(mConnectionId)));
				if (uHandler == null) {
					Log.e(TAG,
							"Error, can not get OceanSurveyFullyManagedServiceConnection handler");
					return;
				}
	...
	protected void onServiceConnectionRequested(SAPeerAgent peerAgent) {
		...
		Log.d("OceanSurveyFullyManagedService", "CONNECTION REQUESTED : "
